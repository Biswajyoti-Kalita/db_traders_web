...
const role = 1;
					app.post("/client/addorder",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			total_price : req.body.total_price,
					...
					app.post("/client/updateorder",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			total_price : req.body.total_price,
					...
					app.post("/client/deleteorder",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/client/bulkdeleteorder", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/client/getorders",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/client/getorder",  roleService.verifyRole(role),  async function(req, res) {
				    try {
