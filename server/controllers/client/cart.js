...
const role = 1;
					app.post("/client/addcart",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			status : req.body.status,
					...
					app.post("/client/updatecart",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			status : req.body.status,
					...
					app.post("/client/deletecart",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/client/bulkdeletecart", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/client/getcarts",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				    ...
				    try {
					        const carts = await db.cart.findAndCountAll({
					        where: where,
				...
				app.post("/client/getcart",  roleService.verifyRole(role),  async function(req, res) {
				    try {
