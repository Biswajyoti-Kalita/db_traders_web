...
const role = 1;
					app.post("/client/addbrand",roleService.verifyRole(role),   async function(req, res) {
					    try {
							  ...
							  if(req.body.image === null || req.body.image === undefined)
								  return res.send({status  : "error", message : " Image is required " })
			...
			image : req.body.image,
					...
					app.post("/client/updatebrand",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			image : req.body.image,
					...
					app.post("/client/deletebrand",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/client/bulkdeletebrand", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/client/getbrands",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/client/getbrand",  roleService.verifyRole(role),  async function(req, res) {
				    try {
