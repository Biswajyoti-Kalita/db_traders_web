...
const role = 1;
					app.post("/client/addimage",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			size : req.body.size,
					...
					app.post("/client/updateimage",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			size : req.body.size,
					...
					app.post("/client/deleteimage",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/client/bulkdeleteimage", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/client/getimages",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/client/getimage",  roleService.verifyRole(role),  async function(req, res) {
				    try {
