...
const role = 1;
					app.post("/client/addorder_item",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			discount : req.body.discount,
					...
					app.post("/client/updateorder_item",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			discount : req.body.discount,
					...
					app.post("/client/deleteorder_item",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/client/bulkdeleteorder_item", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/client/getorder_items",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/client/getorder_item",  roleService.verifyRole(role),  async function(req, res) {
				    try {
