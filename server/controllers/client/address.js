...
const role = 1;
					app.post("/client/addaddress",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			tag : req.body.tag,
					...
					app.post("/client/updateaddress",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			tag : req.body.tag,
					...
					app.post("/client/deleteaddress",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/client/bulkdeleteaddress", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/client/getaddresses",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/client/getaddress",  roleService.verifyRole(role),  async function(req, res) {
				    try {
