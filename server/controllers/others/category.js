...
const role = 2;
					app.post("/others/addcategory",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			image_url : req.body.image_url,
					...
					app.post("/others/updatecategory",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			image_url : req.body.image_url,
					...
					app.post("/others/deletecategory",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/others/bulkdeletecategory", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/others/getcategories",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/others/getcategory",  roleService.verifyRole(role),  async function(req, res) {
				    try {
