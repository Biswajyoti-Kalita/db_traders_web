...
const role = 2;
					app.post("/others/addaddress",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			tag : req.body.tag,
					...
					app.post("/others/updateaddress",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			tag : req.body.tag,
					...
					app.post("/others/deleteaddress",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/others/bulkdeleteaddress", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/others/getaddresses",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/others/getaddress",  roleService.verifyRole(role),  async function(req, res) {
				    try {
