...
const role = 2;
					app.post("/others/adduser",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			username : randomstring.generate(),password: await passwordService.hashPassword(req.body.password),
					...
					app.post("/others/updateuser",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			password: await passwordService.hashPassword(req.body.password),
					...
					app.post("/others/deleteuser",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/others/bulkdeleteuser", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/others/getusers",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/others/getuser",  roleService.verifyRole(role),  async function(req, res) {
				    try {
