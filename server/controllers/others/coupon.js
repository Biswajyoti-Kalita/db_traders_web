...
const role = 2;
					app.post("/others/addcoupon",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			discount_amount : req.body.discount_amount,
					...
					app.post("/others/updatecoupon",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			discount_amount : req.body.discount_amount,
					...
					app.post("/others/deletecoupon",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/others/bulkdeletecoupon", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/others/getcoupons",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/others/getcoupon",  roleService.verifyRole(role),  async function(req, res) {
				    try {
