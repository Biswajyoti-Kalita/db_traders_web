...
const role = 2;
					app.post("/others/addbrand",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			image : req.body.image,
					...
					app.post("/others/updatebrand",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			image : req.body.image,
					...
					app.post("/others/deletebrand",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/others/bulkdeletebrand", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/others/getbrands",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/others/getbrand",  roleService.verifyRole(role),  async function(req, res) {
				    try {
