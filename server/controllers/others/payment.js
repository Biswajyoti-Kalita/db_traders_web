...
const role = 2;
					app.post("/others/addpayment",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			payment_status : req.body.payment_status,
					...
					app.post("/others/updatepayment",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			payment_status : req.body.payment_status,
					...
					app.post("/others/deletepayment",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/others/bulkdeletepayment", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/others/getpayments",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/others/getpayment",  roleService.verifyRole(role),  async function(req, res) {
				    try {
