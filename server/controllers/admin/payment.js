...
const role = 0;
					app.post("/admin/addpayment",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			payment_status : req.body.payment_status,
					...
					app.post("/admin/updatepayment",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			payment_status : req.body.payment_status,
					...
					app.post("/admin/deletepayment",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/admin/bulkdeletepayment", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/admin/getpayments",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/admin/getpayment",  roleService.verifyRole(role),  async function(req, res) {
				    try {
