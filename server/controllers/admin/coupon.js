...
const role = 0;
					app.post("/admin/addcoupon",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			discount_amount : req.body.discount_amount,
					...
					app.post("/admin/updatecoupon",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			discount_amount : req.body.discount_amount,
					...
					app.post("/admin/deletecoupon",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/admin/bulkdeletecoupon", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/admin/getcoupons",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/admin/getcoupon",  roleService.verifyRole(role),  async function(req, res) {
				    try {
