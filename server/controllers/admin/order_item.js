...
const role = 0;
					app.post("/admin/addorder_item",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			discount : req.body.discount,
					...
					app.post("/admin/updateorder_item",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			discount : req.body.discount,
					...
					app.post("/admin/deleteorder_item",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/admin/bulkdeleteorder_item", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/admin/getorder_items",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/admin/getorder_item",  roleService.verifyRole(role),  async function(req, res) {
				    try {
