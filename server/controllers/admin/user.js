...
const role = 0;
					app.post("/admin/adduser",roleService.verifyRole(role),   async function(req, res) {
					    try {
			...
			username : randomstring.generate(),password: await passwordService.hashPassword(req.body.password),
					...
					app.post("/admin/updateuser",  roleService.verifyRole(role),  async function(req, res) {
					    try {
			...
			password: await passwordService.hashPassword(req.body.password),
					...
					app.post("/admin/deleteuser",  roleService.verifyRole(role),  async function(req, res) {
					...
					app.post("/admin/bulkdeleteuser", roleService.verifyRole(role),  async function(req, res) {
				...
				app.post("/admin/getusers",  roleService.verifyRole(role),  async function(req, res) {
	...
	;
				...
				app.post("/admin/getuser",  roleService.verifyRole(role),  async function(req, res) {
				    try {
